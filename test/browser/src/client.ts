...
async function initialize(conn : proto.ProtocolConnection) {
    ...
    await conn.sendRequest(proto.InitializeRequest.type, initializeParameters)
...
export async function start() {
    ...
    await conn.sendNotification(proto.DidOpenTextDocumentNotification.type, openParams);
