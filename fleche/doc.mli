...
module Node : sig
  ...
  type t = private
    ...
    ; diags : Coq.Pp_t.t Lang.Diagnostic.t list  (** Diagnostics associated to the node *)
...
type t = private
  ...
  ; toc : Node.t Coq.Utils.StringMap.t  (** table of contents *)
...
val save : token:Coq.Limits.Token.t -> doc:t -> (unit, Coq.Loc_t.t) Coq.Protect.E.t
